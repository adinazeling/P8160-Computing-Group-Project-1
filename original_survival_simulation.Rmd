...
#uncensored
performance = obtain_performance(baseline_hazard = "weibull", censor = "FALSE")

min_bias = min(performance$exp_bias, performance$weibull_bias, performance$cox_bias)
max_bias = max(performance$exp_bias, performance$weibull_bias, performance$cox_bias)

plot(performance$exp_bias, ylim = c(min_bias, max_bias), main = "Sample size vs. Bias without Censoring")
lines(performance$cox_bias, col = "red")
lines(performance$weibull_bias, col = "blue")

min_MSE = min(performance$exp_MSE, performance$weibull_MSE, performance$cox_MSE)
max_MSE = max(performance$exp_MSE, performance$weibull_MSE, performance$cox_MSE)

plot(performance$exp_MSE, ylim = c(min_MSE, max_MSE), main = "Sample size vs. MSE without Censoring")
lines(performance$cox_MSE, col = "red")
lines(performance$weibull_MSE, col = "blue")

#censored
performance = obtain_performance(baseline_hazard = "weibull", censor = "TRUE")

min_bias = min(performance$exp_bias, performance$weibull_bias, performance$cox_bias)
max_bias = max(performance$exp_bias, performance$weibull_bias, performance$cox_bias)

plot(performance$exp_bias, main = "Sample size vs. Bias with Censoring")
lines(performance$cox_bias, col = "red")
lines(performance$weibull_bias, col = "blue")
...
plot(performance$exp_MSE, main = "Sample size vs. MSE with Censoring")
lines(performance$cox_MSE, col = "red")
lines(performance$weibull_MSE, col = "blue")
